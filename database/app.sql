...
ALTER TABLE repositories ADD COLUMN IF NOT EXISTS private BOOL DEFAULT TRUE;
ALTER TABLE repositories ADD COLUMN IF NOT EXISTS filename VARCHAR;
ALTER TABLE repositories ADD COLUMN IF NOT EXISTS updated TIMESTAMP DEFAULT NOW();
...
ALTER TABLE installations ADD COLUMN IF NOT EXISTS installed TIMESTAMP DEFAULT NOW();
